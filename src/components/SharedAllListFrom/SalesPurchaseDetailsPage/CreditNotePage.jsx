      ...
      >
        ...
        <div className="px-3 py-3 bg-white">
          <Form layout="vertical" className="grid grid-cols-12 gap-4">
            ...
            {/* Start Date */}
            <Form.Item label="Start Date" className="col-span-12 md:col-span-3">
              <DatePicker
                className="w-full"
                format="DD MMMM, YYYY"
            ...
            {/* End Date */}
            <Form.Item label="End Date" className="col-span-12 md:col-span-3">
              <DatePicker
                className="w-full"
                format="DD MMMM, YYYY"
                suffixIcon={<CalendarOutlined />}
        ...
        <div className="bg-white px-3 py-4 text-center">
          ...
          <div className="flex justify-between text-xs mt-4 mb-2">
            ...
            <div className="text-right">
              <p>Print Date: 10/11/2025 12:53 PM</p>
            </div>
          </div>
